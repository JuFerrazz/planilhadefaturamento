        ...
        <div className="print:border-0" style={{ border: '2px solid #000080' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '50%' }}>
              ...
              <div style={{ padding: '3px 5px', fontWeight: 'bold', minHeight: '30px' }}>
                {data.shipperName || '[SHIPPER NAME]'}
              </div>
              <div style={{ padding: '3px 5px', minHeight: '15px' }}>
          ...
          {/* COPY NOT NEGOTIABLE */}
          <div style={{ textAlign: 'right', padding: '5px 20px', fontWeight: 'bold', fontSize: '11px', letterSpacing: '0.15em' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '75%', borderRight: '2px solid #000080' }}>
              ...
              <div style={{ padding: '6px 20px', minHeight: '140px' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '30%', borderRight: '2px solid #000080', padding: '5px' }}>
              ...
              <div style={{ height: '15px', borderBottom: '2px solid #000080' }} />
            ...
            <div style={{ width: '70%' }}>
              ...
              <div style={{ padding: '0 5px', fontSize: '10px', paddingLeft: '40px' }}>
              ...
              {/* FOR CONDITIONS line */}
              <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '10px', borderTop: '1px solid #000080', borderBottom: '1px solid #000080', padding: '5px', marginTop: '8px' }}>
              ...
              <div style={{ display: 'flex' }}>
                ...
                <div style={{ width: '60%', padding: '5px' }}>
                  ...
                  <div style={{ borderTop: '1px solid #000080', marginTop: '8px', paddingTop: '5px' }}>
