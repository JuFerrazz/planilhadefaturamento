        ...
        <div className="print:border-0" style={{ border: '2px solid #000080' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '50%' }}>
              ...
              <div style={{ padding: '2px 4px', fontWeight: 'bold', minHeight: '24px' }}>
          ...
          {/* COPY NOT NEGOTIABLE */}
          <div style={{ textAlign: 'right', padding: '4px 16px', fontWeight: 'bold', fontSize: '10px', letterSpacing: '0.15em' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '75%', borderRight: '2px solid #000080' }}>
              ...
              <div style={{ padding: '4px 16px', minHeight: '100px' }}>
                ...
                <div style={{ fontSize: '9px', fontStyle: 'italic', paddingLeft: '16px' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '70%' }}>
              ...
              <div style={{ padding: '0 4px', fontSize: '9px', paddingLeft: '32px' }}>
              ...
              {/* FOR CONDITIONS line */}
              <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '9px', borderTop: '1px solid #000080', borderBottom: '1px solid #000080', padding: '4px', marginTop: '6px' }}>
