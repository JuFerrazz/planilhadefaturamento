        ...
        <div className="print:border-0" style={{ border: '2px solid #000080' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '50%' }}>
              ...
              <div style={{ padding: '2px 4px', fontWeight: 'bold', minHeight: '25px' }}>
                {data.shipperName || '[SHIPPER NAME]'}
              </div>
              <div style={{ padding: '2px 4px', minHeight: '12px' }}>
          ...
          {/* COPY NOT NEGOTIABLE */}
          <div style={{ textAlign: 'right', padding: '3px 15px', fontWeight: 'bold', fontSize: '10px', letterSpacing: '0.15em' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '75%', borderRight: '2px solid #000080' }}>
              ...
              <div style={{ padding: '4px 15px', minHeight: '140px' }}>
                ...
                <div style={{ fontSize: '9px', fontStyle: 'italic', paddingLeft: '15px' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '30%', borderRight: '2px solid #000080', padding: '3px' }}>
              ...
              <div style={{ padding: '3px 0', fontWeight: 'bold' }}>
            ...
            <div style={{ width: '70%' }}>
              ...
              <div style={{ padding: '0 3px', fontSize: '9px', paddingLeft: '35px' }}>
                order&nbsp;&nbsp;&nbsp;and&nbsp;&nbsp;&nbsp;condition&nbsp;&nbsp;&nbsp;on&nbsp;&nbsp;board&nbsp;&nbsp;the&nbsp;&nbsp;Vessel
              </div>
              <div style={{ padding: '0 3px', fontSize: '9px' }}>
              ...
              {/* FOR CONDITIONS line */}
              <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '9px', borderTop: '1px solid #000080', borderBottom: '1px solid #000080', padding: '3px', marginTop: '6px' }}>
                FOR CONDITIONS OF CARRIAGE SEE OVERLEAF
              </div>

              {/* Bottom sub-sections - 2 columns */}
              <div style={{ display: 'flex' }}>
                <div style={{ width: '40%', borderRight: '1px solid #000080', padding: '3px' }}>
                  <div style={{ fontSize: '8px' }}>Freight payable at</div>
                  <div style={{ height: '12px' }} />
                  <div style={{ borderTop: '1px solid #000080', paddingTop: '3px' }}>
                    <div style={{ fontSize: '8px' }}>Number of original Bs/L</div>
                    <div style={{ height: '6px' }} />
                    <div style={{ fontWeight: 'bold', fontSize: '11px', textAlign: 'center' }}>3 ( THREE)</div>
                  </div>
                </div>
                <div style={{ width: '60%', padding: '3px' }}>
                  ...
                  <div style={{ borderTop: '1px solid #000080', marginTop: '6px', paddingTop: '3px' }}>
                    <div style={{ fontSize: '8px' }}>Signature</div>
                    <div style={{ borderBottom: '1px solid #000080', width: '90%', marginTop: '10px', marginBottom: '3px' }} />
