    ...
    <div className="space-y-4 print:space-y-0 print:w-full print:h-full">
      ...
      >
        ...
        <div className="print:border-0" style={{ border: '2px solid #000080' }}>
          ...
          {/* CODE NAME Header */}
          <div style={{ fontSize: '10px', padding: '3px 5px', fontWeight: 'bold' }}>
          ...
          <div style={{ display: 'flex' }}>
            {/* Left: Shipper */}
            <div style={{ width: '50%' }}>
              <div style={{ fontSize: '9px', padding: '2px 5px' }}>Shipper</div>
              <div style={{ padding: '3px 5px', fontWeight: 'bold', minHeight: '35px' }}>
                {data.shipperName || '[SHIPPER NAME]'}
              </div>
              <div style={{ padding: '3px 5px', minHeight: '18px' }}>
                CNPJ {data.shipperCnpj || '[CNPJ]'}
              </div>
            </div>
            {/* Center: BILL OF LADING */}
            <div style={{ width: '30%', textAlign: 'center' }}>
              <div style={{ fontWeight: 'bold', fontSize: '15px', paddingTop: '6px' }}>
                BILL OF LADING
              </div>
              <div style={{ fontSize: '9px', paddingTop: '3px' }}>
                TO BE USED WITH CHARTER-PARTIES
              </div>
            </div>
            {/* Right: B/L No. and Reference */}
            <div style={{ width: '20%' }}>
              <div style={{ fontWeight: 'bold', fontSize: '11px', padding: '3px 5px' }}>
                B/L No. {data.blNumber || '1'}
              </div>
              <div style={{ height: '25px' }} />
              <div style={{ fontSize: '9px', padding: '3px 5px' }}>Reference No.</div>
            </div>
          </div>

          {/* COPY NOT NEGOTIABLE */}
          <div style={{ textAlign: 'right', padding: '5px 18px', fontWeight: 'bold', fontSize: '11px', letterSpacing: '0.15em' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '75%', borderRight: '2px solid #000080' }}>
              <div style={{ fontSize: '9px', padding: '3px 5px' }}>Shipper's description of goods</div>
              <div style={{ padding: '6px 20px', minHeight: '180px' }}>
                ...
                <div style={{ fontSize: '10px', fontStyle: 'italic', paddingLeft: '20px' }}>
            ...
            {/* Right: Gross weight */}
            <div style={{ width: '25%' }}>
              <div style={{ fontSize: '9px', padding: '3px 5px' }}>Gross weight</div>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '30%', borderRight: '2px solid #000080', padding: '5px' }}>
              ...
              <div style={{ borderBottom: '1px solid #000080', width: '90%', marginBottom: '10px' }} />
              <div style={{ height: '20px' }} />
              <div style={{ fontSize: '9px', fontStyle: 'italic' }}>Time used for loading............ ....days.... .............hours.</div>
              <div style={{ height: '20px', borderBottom: '2px solid #000080' }} />
            ...
            <div style={{ width: '70%' }}>
              ...
              <div style={{ padding: '0 5px', fontSize: '10px', paddingLeft: '45px' }}>
                order&nbsp;&nbsp;&nbsp;and&nbsp;&nbsp;&nbsp;condition&nbsp;&nbsp;&nbsp;on&nbsp;&nbsp;board&nbsp;&nbsp;the&nbsp;&nbsp;Vessel
              </div>
              <div style={{ padding: '0 5px', fontSize: '10px' }}>
              ...
              {/* FOR CONDITIONS line */}
              <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '10px', borderTop: '1px solid #000080', borderBottom: '1px solid #000080', padding: '5px', marginTop: '10px' }}>
                FOR CONDITIONS OF CARRIAGE SEE OVERLEAF
              </div>

              {/* Bottom sub-sections - 2 columns */}
              <div style={{ display: 'flex' }}>
                <div style={{ width: '40%', borderRight: '1px solid #000080', padding: '5px' }}>
                  <div style={{ fontSize: '9px' }}>Freight payable at</div>
                  <div style={{ height: '20px' }} />
                  <div style={{ borderTop: '1px solid #000080', paddingTop: '5px' }}>
                    <div style={{ fontSize: '9px' }}>Number of original Bs/L</div>
                    <div style={{ height: '10px' }} />
                    <div style={{ fontWeight: 'bold', fontSize: '13px', textAlign: 'center' }}>3 ( THREE)</div>
                  </div>
                </div>
                <div style={{ width: '60%', padding: '5px' }}>
                  ...
                  <div style={{ fontWeight: 'bold', fontSize: '10px' }}>{issuePlace}, BRAZIL, {issueDateFormatted}</div>
                  <div style={{ borderTop: '1px solid #000080', marginTop: '10px', paddingTop: '5px' }}>
                    <div style={{ fontSize: '9px' }}>Signature</div>
                    <div style={{ borderBottom: '1px solid #000080', width: '90%', marginTop: '15px', marginBottom: '5px' }} />
