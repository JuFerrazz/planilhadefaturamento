        ...
        <div className="print:border-0" style={{ border: '2px solid #000080' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '50%' }}>
              ...
              <div style={{ padding: '3px 5px', fontWeight: 'bold', minHeight: '25px' }}>
                {data.shipperName || '[SHIPPER NAME]'}
              </div>
              <div style={{ padding: '3px 5px', minHeight: '12px' }}>
          ...
          {/* COPY NOT NEGOTIABLE */}
          <div style={{ textAlign: 'right', padding: '4px 20px', fontWeight: 'bold', fontSize: '11px', letterSpacing: '0.15em' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '75%', borderRight: '2px solid #000080' }}>
              ...
              <div style={{ padding: '6px 20px', minHeight: '110px' }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '30%', borderRight: '2px solid #000080', padding: '4px' }}>
              ...
              <div style={{ height: '12px' }} />
              <div style={{ borderBottom: '1px solid #000080', width: '90%', marginBottom: '6px' }} />
              <div style={{ height: '12px' }} />
              <div style={{ fontSize: '9px', fontStyle: 'italic' }}>Time used for loading............ ....days.... .............hours.</div>
              <div style={{ height: '12px', borderBottom: '2px solid #000080' }} />
            ...
            <div style={{ width: '70%' }}>
              ...
              <div style={{ padding: '0 4px', fontSize: '10px', paddingLeft: '40px' }}>
                order&nbsp;&nbsp;&nbsp;and&nbsp;&nbsp;&nbsp;condition&nbsp;&nbsp;&nbsp;on&nbsp;&nbsp;board&nbsp;&nbsp;the&nbsp;&nbsp;Vessel
              </div>
              <div style={{ padding: '0 4px', fontSize: '10px' }}>
              ...
              {/* FOR CONDITIONS line */}
              <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '10px', borderTop: '1px solid #000080', borderBottom: '1px solid #000080', padding: '4px', marginTop: '6px' }}>
              ...
              <div style={{ display: 'flex' }}>
                ...
                <div style={{ width: '60%', padding: '4px' }}>
                  ...
                  <div style={{ borderTop: '1px solid #000080', marginTop: '6px', paddingTop: '4px' }}>
                    <div style={{ fontSize: '9px' }}>Signature</div>
                    <div style={{ borderBottom: '1px solid #000080', width: '90%', marginTop: '12px', marginBottom: '4px' }} />
