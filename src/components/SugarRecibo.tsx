        ...
        <tbody>
          {entries.map((entry, idx) => (
            <tr key={idx} className="border-b border-gray-300">
              <td className="py-2">{entry.blNumber}</td>
              <td className="py-2">{entry.shipper}</td>
              <td className="py-2 text-right">{formatQuantity(entry.quantity)}</td>
            </tr>
          ))}
        </tbody>
      </table>
