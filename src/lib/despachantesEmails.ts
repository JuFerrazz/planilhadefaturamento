...
export const DESPACHANTES_EMAILS: Record<string, string> = {
  ...
  'ALP LOGISTICA ADUANEIRA LTDA': 'junior@alplog.com.br; exec@alplog.com.br',
  'ALP LOGISTICA': 'junior@alplog.com.br; exec@alplog.com.br',
  'ALP': 'junior@alplog.com.br; exec@alplog.com.br',
